...
namespace ZHIHAO
{
    ...
    {
        // Default constructor
        Point::Point(): m_x(0.0), m_y(0.0) {std::cout<<this->ToString()<<" constructed by default"<<endl;}

        // Constructor with user input
        Point::Point(double x, double y): m_x(x), m_y(y) {std::cout<<this->ToString()<<" constructed by input"<<endl;}

        // Copy constructor
        Point::Point(const Point& pt): m_x(pt.X()), m_y(pt.Y()) {std::cout<<this->ToString()<<" constructed by copy"<<endl;}
