...
{
    //cout << "NumericArray constructed by default." << endl;
}
...
{
    //cout << "NumericArray constructor with input size." << endl;
}
...
{
    //cout << "NumericArray constructed by copy." << endl;
}
...
{
    //cout << "NumericArray destructed." << endl;
}
